...
function ContactHeroScene() {
  ...
  const constellationConfig = {
    nodes: [
      ...
      { id: 'contact-3', position: [0, -1.5, 0] as [number, number, number], size: 0.25, label: '' },
      { id: 'contact-4', position: [-1.5, 0, 0] as [number, number, number], size: 0.15, label: '' },
      { id: 'contact-5', position: [1.5, 0, 0] as [number, number, number], size: 0.15, label: '' },
    ],
    connections: [[0, 3], [3, 2], [2, 4], [4, 1], [0, 4], [1, 3]] as [number, number][],
    color: '#fbbf24',
    glowIntensity: 0.8,
    animationSpeed: 0.5,
  };
