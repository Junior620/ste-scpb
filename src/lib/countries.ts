...
export const PRIORITY_COUNTRIES: Country[] = [
  ...
  { code: 'US', name: { fr: 'États-Unis', en: 'United States', ru: 'Соединённые Штаты Америки' } },
...
export const ALL_COUNTRIES: Country[] = [
  ...
  { code: 'ZA', name: { fr: 'Afrique du Sud', en: 'South Africa', ru: 'Южная Африка' } },
  ...
  {
    code: 'CD',
    name: { fr: 'Congo (RDC)', en: 'DR Congo', ru: 'Демократическая Республика Конго' },
  },
